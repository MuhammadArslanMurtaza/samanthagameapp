...
class substractions extends React.Component {
  constructor(props){
          super(props);
          this.state={
               play: true,
    ...
    backgroundColor:'rgb(0 0 0 / 0%)',
     ...
     for(var i = 0; i < this.state.slctRandomnumber[0]; i++){
                    this.lis1.push(<div key={i} className=" text-center">
                         <img alt="mathgame" src={this.state.slctRandomimg[0][0][1]} className="w-24 md:h-24" />
                    </div>)
                    }
                    this.setState({
                         lis1:this.lis1
  ...
  togglePlay = () => {
     ...
     for(var i = 0; i < this.state.slctRandomnumber[1]; i++){
                    this.lis2.push(<div key={i} className=" text-center">
                         <img alt="mathgame" src={this.state.slctRandomimg[1][1]} className="w-24 md:h-24" />
                    </div>)
                    }
                    this.setState({
                         lis2:this.lis2
        ...
        >
         ...
         <Link to="/Mathgames">
          ...
          <div className="grid grid-cols-3 titl">
               <div></div>
               <h1 className=" mathqus text-white text-center">Subtraction</h1>
